...
**[!UICONTROL 文章點] 欄位，新增至任務和問題清單與報告**

_報告_

此 [!UICONTROL 文章點] 欄位現在可新增至任務或問題的清單和報表。 它是可編輯、自由的表單欄位，不與計畫小時數或團隊指派系結。
...
此 [!UICONTROL 展示板] 圖示現在會顯示在 [!UICONTROL 主菜單] 沒有版面範本的使用者。 對於新建立的所有展示版範本，展示版也依預設包含在主選單中。現有的版面範本不會改變。
