...
「載入此展示板時發生錯誤。 重新整理頁面以重試，如果問題仍然存在，請聯絡支援人員，並提供下方的錯誤ID。」

#### 首頁

**「標籤為完成」關閉「我的問題」Widget**&#x200B;的摘要窗格

當嘗試在「我的問題」小工具開啟的問題摘要窗格中使用「標記為已完成」按鈕時，摘要窗格意外地關閉。

**配置範本介面工具集設定無法新增欄**

透過「版面配置範本Widget」設定選取要新增至Widget的欄位時，可以選取欄位，但對應的欄未出現在Widget中。
...
將費用新增到任務後，儘管已輸入API確認，該費用未出現在任務資訊中。
