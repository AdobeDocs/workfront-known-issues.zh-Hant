...
新待辦事項的待辦事項Widget發生&#x200B;**個錯誤，且已完成待辦事項**

在首頁待辦事項小工具中，當使用者嘗試建立新的待辦事項或完成現有待辦事項時會遇到錯誤，無法建立或完成待辦事項。

#### 使用者

**「傳送邀請電子郵件給這些人員」核取方塊遺失**

將新使用者匯入Workfront時，對話方塊視窗中缺少「傳送邀請電子郵件給這些人員」核取方塊。
...
當使用者指派任務並開始輸入在任務期間已計畫休假的受指派人名稱時，建議指派區域下的使用者圖示不顯示休假（飛機）圖示。 如果使用者繼續輸入以讓名稱顯示在『使用者和團隊』區域下，就會顯示休假圖示。
