...
**關於 [!UICONTROL apiKey] in [!DNL Workfront] > [!UICONTROL 觀看事件] 模組**

*[!DNL Workfront Fusion]*

當使用者嘗試將網頁連結新增至 [!DNL Workfront] > [!UICONTROL 觀看事件] 模組，他們收到下列錯誤：

&quot;[!UICONTROL 提供的apiKey為空或被視為無效。]&quot;
