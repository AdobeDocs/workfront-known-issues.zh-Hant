...
**在中重新排序任務時沒有錯誤訊息 [!UICONTROL 未決核准] 狀態**
...
當使用者嘗試重新排序任務清單中[!UICONTROL 待核准]狀態的任務時，任務有在任務清單中移動。重新整理後，使用者看到該任務沒有移動。專案無法移動，因為前置任務無法移動到其前置任務所在的任務之下，但沒有訊息告訴使用者專案無法移動，這可能會導致混淆。
