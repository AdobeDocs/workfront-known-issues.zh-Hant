...
>[!NOTE]
>
>此問題已於2022年10月13日預覽中修正。 它已於2022年10月27日正式投產。
...
**列於 [!UICONTROL 工作負載平衡器] 在中使用分享連結時 [!DNL Safari] 瀏覽器**

*[!UICONTROL 工作負載平衡器]*

當使用者遵循的分享連結 [!UICONTROL 工作負載平衡器] 使用 [!DNL Safari] 瀏覽器時，他們會看見所有使用者，而不只是列出團隊的成員。
...
當使用者查看[!UICONTROL 人們]專案的區域並選擇[!UICONTROL 全部更新]選項，然後輸入更新，更新未發佈到專案本身。相反，它會發佈到專案中每個使用者的個人使用者設定檔中。
