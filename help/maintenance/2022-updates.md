...
description: '[!DNL Adobe Workfront]的2022年維護更新'
...
「[!UICONTROL 錯誤。 抱歉！ 只有擁有計畫授權的使用者可以核准或拒絕時程表。 請聯絡您的系統管理員。]」
...
* 因無效 SQL 語句資料庫出錯。
* 您最近的變更未儲存。 重新整理頁面以檢視上次儲存的變更。

+++

+++**2022 年 12 月 1 日的維護更新 (Hot Fix)**
...
+++**[!DNL Workfront Fusion]2022 年 11 月 3 日的維護更新**
...
當使用者作為審閱者或請求者新增到校訂時，他們將獲得「[!UICONTROL 訪客]」權限設定檔，該設定檔不應使用 [!DNL Workfront Proof] 授權。 但是，當新增使用者時，使用的 [!DNL Workfront Proof] 授權的數量會增加。

+++

+++**2022 年 10 月 11 日的維護更新**
...
+++**[!DNL Workfront Scenario Planner]2022 年 9 月 15 日的維護更新**
...
* 校訂作用 ([!UICONTROL 審閱者]、[!UICONTROL 核准者])
...
+++**於 2022 年 6 月 24 日的維護更新 (Hot Fix)**
...
+++**[!DNL Workfront]Scenario Planner 2022 年 6 月 23 日的維護更新**
...
+++**[!DNL Workfront Scenario Planner]2022 年 6 月 9 日的維護更新**
...
+++**[!DNL Workfront Fusion]2022 年 6 月 9 日的維護更新**

**自訂表單中的資料在 [!DNL Workfront Fusion] [!DNL Workfront] 模組中無法使用**

*[!DNL Workfront Fusion]*

當使用者在 [!DNL Workfront Fusion] 中設定 [!DNL Workfront] 模組，並嘗試為模組選擇輸出，自訂表單中的欄位不可見 當為一種類型的 [!DNL Workfront] 物件建立自訂表單，然後將另一種類型新增到其中時，就會發生這種情況。 [!DNL Workfront Fusion] 僅顯示最初為所選物件類型建立的自訂表單中的欄位。
...
為了提高更新區域的效能，我們針對可以在更新或對現有更新的回覆中輸入的字元數有了新限制。 新限制為 15,000 個字元。 此更新未變更使用 API 時允許的字元數。 更新的 API 字元限制為 4,000。 更新
支援工作負載平衡器篩選器中的Typehead型別自訂欄位
...
+++**於 2022 年 4 月 25 日的維護更新 (Hot Fix)**
...
+++**於 2022 年 3 月 29 日的維護更新 (Hot Fix)**
...
+++**於 2022 年 3 月 14 日的維護更新 (Hot Fix)**
...
當使用[!UICONTROL 里程碑]視圖顯示專案報告時，使用者會收到「[!UICONTROL APIModel INTERNAL 不支援命名查詢 TILE:milestone-view (UIVW) &#x200B;]」 的錯誤訊息。
...
**&quot;[!UICONTROL 此核准程式可用於……]&quot; 欄位遺失**

*核准*

當使用者在[!UICONTROL 設定]區域中建立或編輯核准流程時，「[!UICONTROL 此核准流程可用於……]」 欄位遺失。 這可能在建立核准流程或編輯現有核准流程時發生。
...
+++**[!DNL Workfront Fusion]2022 年 2 月 18 日的維護更新**
...
當使用者在[!DNL Workfront Classic]檔案清單中選擇檔案或校訂，然後按一下「[!UICONTROL 更多]」時，他們可能會看到以下問題之一：
按鈕無回應
按鈕下的所有選項都標示為「[!UICONTROL 物件物件]」且無法使用。
...
+++**[!DNL Workfront Fusion]2022 年 1 月 14 日的維護更新**
...
**[!UICONTROL 工作負載平衡器]： &quot;[!UICONTROL ？[物件物件]？]&quot; 顯示在過度配置資訊中**

*[!UICONTROL 工作負載平衡器]*

如果由於一項任務與使用者的休假時間重疊，使用者在[!UICONTROL 工作負載平衡器]中顯示為過度指派，且另一個使用者檢視了他們的過度指派，則過度指派資訊的&quot;[!UICONTROL 容量]&quot;區域會顯示&quot;[!UICONTROL ？[物件物件]？]&quot; 而不是使用者的實際容量。
