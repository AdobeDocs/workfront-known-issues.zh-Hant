...
| **問題** | **上次修改** |
| ----------------------------------------------------------------- | ----------------- |
| [範本：無法與Contribute存取權共用](/help/known-issues/known-issues-workfront/wf-templates-cannot-share-from-template-menu.md) | 2025年4月11日 |
...
| **問題** | **上次修改** |
| ---------------------------------- | ----------------- |
| [要求：內嵌程式碼URL未正確載入要求佇列](known-issues-workfront/wf-requests-embed-code-does-not-load-request-correctly.md) | 2025年4月10日 |
