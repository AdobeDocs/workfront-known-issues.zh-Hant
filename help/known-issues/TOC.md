...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + [!DNL Adobe Workfront] {#wf-current}中目前的問題
      ...
      + [校訂：在校訂加上註解時，出現額外、空白的註解](known-issues-workfront/wf-proofs-extra-blank-comment.md)
      ...
      + [更新：以新的註解體驗建立的註解在舊的體驗中看不到](known-issues-workfront/wf-updates-comment-not-visible-in-legacy.md)
      + [更新：註解顯示為來自不正確的使用者](known-issues-workfront/wf-updates-comment-displays-as-wrong-user.md)
...
+ [!DNL Workfront Proof] {#proof}
   ...
   + [!DNL Workfront Proof] {#proof-current}中目前的問題
      ...
      + [無法透過在註解中標記使用者來將使用者新增到校訂中](known-issues-workfront-proof/cannot-add-user-to-proof.md)
