...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + [!DNL Adobe Workfront] {#wf-current}中目前的問題
      ...
      + [展示板：卡片的「評論」區段顯示錯誤](known-issues-workfront/wf-boards-comment-section-error.md)
      ...
      + [文件：「[!UICONTROL 傳送到]」選項導致空白頁面和錯誤訊息](known-issues-workfront/wf-documents-sent-to-goes-blank.md)
      ...
      + [校訂：在校訂加上評論時，出現額外、空白的評論](known-issues-workfront/wf-proofs-extra-blank-comment.md)
      + [展示板：無標題卡片出現在待辦項目中](known-issues-workfront/wf-boards-untitled-cards-displaying-and-saved.md)
      + [校訂：校訂產生時間過長](known-issues-workfront/wf-proofs-proof-takes-days-to-generate.md)
      + [文件：無法將文件移至不同資料夾](known-issues-workfront/wf-documents-cannot-move-to-folder.md)
      + [校訂：校訂顯得不夠飽和或被裁切](known-issues-workfront/wf-proofs-desaturated-and-cropped.md)
      + [更新：以新的評論體驗建立的評論在舊的體驗中看不到](known-issues-workfront/wf-updates-comment-not-visible-in-legacy.md)
      + [更新：評論顯示為來自不正確的使用者](known-issues-workfront/wf-updates-comment-displays-as-wrong-user.md)
      + [展示板：無法在工作流的展示板上指派使用者](known-issues-workfront/wf-boards-cannot-add-user-to-workstream-board.md)
      + [篩選器：共用篩選器時按鈕標籤為「[!UICONTROL 已棄用]」](known-issues-workfront/wf-filters-buttons-display-as-deprecated.md)
      ...
      + [工作量平衡工具：時數意外重新分配](known-issues-workfront/wf-workload-balancer-hours-redistribute.md)
