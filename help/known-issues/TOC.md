...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + [!DNL Adobe Workfront] {#wf-current}中目前的問題
      ...
      + [校訂：校訂產生速度非常慢](/help/known-issues/known-issues-workfront/wf-proofs-generation-takes-long-time.md)
      ...
      + [校訂：無法為透過 Fusion 從 AEM 連結的影片建立校訂](/help/known-issues/known-issues-workfront/wf-proof-cannot-generate-aem-video.md)
      ...
      + [報告：檢視依自訂日期分組的報告詳細資料時發生錯誤](known-issues-workfront/wf-reports-error-with-custom-date-field.md)
      ...
      + [文件：使用前往文件的公開連結時發生錯誤](/help/known-issues/known-issues-workfront/wf-documents-public-link-not-working.md)
      ...
      + [時程表：釘選的時程表會導向空白頁面](known-issues-workfront/inactive/wf-timesheets-pinned-goes-to-blank-page.md)
      ...
      + [任務：新增或刪除任務時發生資料庫錯誤 (原先發生 Bizcontext 錯誤)](known-issues-workfront/wf-tasks-bizcontext-adding-or-deleting.md)
