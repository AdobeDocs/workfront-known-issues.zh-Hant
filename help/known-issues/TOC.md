...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + [!DNL Adobe Workfront] {#wf-current}中目前的問題
      ...
      + [時程表：無法在時程表中輸入時間](known-issues-workfront/wf-timesheets-cannot-enter-time-on-timesheet.md)
      ...
      + [專案：從範本建立專案時出現「糟糕！」錯誤訊息](known-issues-workfront/wf-projects-whoops-error-when-creating-project-from-template.md)
      ...
      + [校訂：無法在  [!DNL Workfront] 中開啟校訂](known-issues-workfront/wf-cannot-open-proof-returns-to-doc-details.md)
      + [任務：在任務中輸入時數時，時數未儲存[!UICONTROL 摘要面板]](known-issues-workfront/wf-hours-do-not-save-when-scrolling-summary-panel.md)
      + [校訂：關閉校訂時使用者未返回上一頁](known-issues-workfront/wf-proofs-user-redirected-to-random-page-when-closing-proof.md)
...
+ [!DNL Workfront Proof] {#proof}
   ...
   + [!DNL Workfront Proof] {#proof-current}中目前的問題
      ...
      + [[!DNL Workfront Proof]：資料夾檢視未顯示校訂](known-issues-workfront-proof/proof-folder-views-not-displaying-proofs.md)
      + [[!DNL Workfront Proof]：無法為超過 1.5GB 的文件建立校訂](known-issues-workfront-proof/proof-cannot-proof-files-over-1-5gb.md)
      + [[!DNL Workfront Proof]：[!UICONTROL 新校訂]頁面缺少文字欄位](known-issues-workfront-proof/proof-new-page-missing-text-fields.md)
      ...
      + [[!DNL Workfront Proof]：新增到校訂的使用者只有「[!UICONTROL 檢視]」存取權](known-issues-workfront-proof/proof-added-users-have-only-view.md)
      + [[!DNL Workfront Proof]：校訂管理員的校訂權限有限](known-issues-workfront-proof/proof-admin-has-limited-permissions.md)
      + [[!UICONTROL 要管理的校訂]中儀表板顯示 0 個校訂](known-issues-workfront-proof/zero-proofs-to-manage.md)
      + [[!DNL Workfront Proof]：互動式校訂中的超連結無效](known-issues-workfront-proof/proof-hyperlinks-are-not-active.md)
      + [在工作流程範本中進行初始設定後無法修改使用者選項](known-issues-workfront-proof/user-options-cannot-be-modified-after-initial-configuration.md)
      + [在校訂中被標記時，使用者未收到通知](known-issues-workfront-proof/users-do-not-receive-notifications-when-tagged-in-a-proof.md)
      + [在[!UICONTROL 校訂檢視器]中所做的評論未即時可見](known-issues-workfront-proof/comments-not-visible-in-real-time.md)
      + [由於截止日期與現有階段的截止日期不相符而建立了新階段](known-issues-workfront-proof/new-stage-created.md)
      + [首頁工作清單中顯示的校訂核准截止日期不準確](known-issues-workfront-proof/inaccurate-proof-approval-deadline-displayed.md)
