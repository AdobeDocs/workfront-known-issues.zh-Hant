...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + [!DNL Adobe Workfront] {#wf-current}中目前的問題
      ...
      + [校訂：階段啟動發生問題](known-issues-workfront/wf-proofs-stage-activation-issues.md)
      + [校訂：從電子郵件連結存取校訂時缺少階層連結](known-issues-workfront/wf-proofs-breadcrumb-missing.md)
      + [要求：將文件新增至要求時欄位會被清除](known-issues-workfront/wf-requests-fields-blank-when-doc-added.md)
      + [更新：透過 API 或  [!DNL Workfront Fusion] 發表的評論中出現額外的行](known-issues-workfront/wf-updates-extra-lines-in-comment-from-api.md)
      ...
      + [[!UICONTROL 工作量平衡工具]：[!UICONTROL 工作量平衡工具]載入緩慢](known-issues-workfront/wf-workload-balancer-loads-slowly.md)
      ...
      + [工作量平衡工具：頁面重新整理之後手動變更的小時數不準確](known-issues-workfront/wf-workload-balancer-hour-changes-not-sticking.md)
      ...
      + [[!UICONTROL 工作量平衡工具]：時數不會根據使用者休假時間進行調整](known-issues-workfront/wf-workload-balancer-assigned-hours-not-adjusting-for-pto.md)
      ...
      + [工作量平衡工具：一次使用多個篩選器時結果會不準確](known-issues-workfront/wf-workload-balancer-multiple-filters.md)
